...
export function TripForm({ form, onSubmit, isLoading, error, isEditMode = false }: TripFormProps) {
                                ...
                                render={({ field }) => (
                                    ...
                                    >
                                        <SelectTrigger className="h-12 bg-muted/30 border-border/50 focus:bg-background transition-colors">
                                            <SelectValue placeholder={t("trips.destination_types.unknown")} />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="unknown" disabled className="text-muted-foreground opacity-50">{t("trips.destination_types.unknown")}</SelectItem>
                                            <SelectItem value="country">{t("trips.destination_types.country")}</SelectItem>
                                            <SelectItem value="city">{t("trips.destination_types.city")}</SelectItem>
                                            <SelectItem value="province">{t("trips.destination_types.province")}</SelectItem>
                                            <SelectItem value="island">{t("trips.destination_types.island")}</SelectItem>
                                            <SelectItem value="other">{t("trips.destination_types.other")}</SelectItem>
                                        </SelectContent>
                                    </Select>
                                )}
                            />
                    ...
                    >
                        {isLoading ? (
                            <>
                                ...
                                {isEditMode ? t("trips.edit.submitting") : t("trips.create.submitting")}
                            </>
                        ) : (
                            <>
                                {isEditMode ? <Save className="mr-2 size-5" /> : <Sparkles className="mr-2 size-5" />}
                                {isEditMode ? t("trips.edit.submit_button") : t("trips.create.submit_button")}
                            </>
                        )}
                    </Button>
                </div>
