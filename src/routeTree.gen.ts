...
import { Route as LayoutTripsTripIdRouteImport } from "./routes/_layout.trips.$tripId";
...
const LayoutTripsIndexRoute = LayoutTripsIndexRouteImport.update({
	...
	import("./routes/_layout.trips.index.lazy").then((d) => d.Route)
);
...
const LayoutTripsTripIdRoute = LayoutTripsTripIdRouteImport.update({
	id: "/$tripId",
	path: "/$tripId",
	getParentRoute: () => LayoutTripsLazyRoute,
} as any).lazy(() =>
