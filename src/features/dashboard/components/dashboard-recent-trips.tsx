        ...
        <div className="group relative overflow-hidden rounded-2xl border border-border/50 bg-background shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1 cursor-pointer">
            ...
            <div className="p-5">
                <div className="flex justify-between items-start mb-2">
                    ...
                    <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded-full border ${status === 'Confirmed' ? 'border-green-500 text-green-600 bg-green-50' : 'border-orange-500 text-orange-600 bg-orange-50'}`}>
                        {status}
                    </span>
                </div>
    ...
    return (
        <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Link to="/trips">
                    <Button variant="ghost" className="hover:bg-transparent hover:text-primary p-0">View all <ArrowUpRight className="ml-1 size-4" /></Button>
                </Link>
            </div>
